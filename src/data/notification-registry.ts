...
export const notificationEventRegistry = {
  ...
  "stage.review_reminded": registerEvent({
    family: "stage", actor: "person-required", project: "required", stage: "event-stage", entityType: "stage",
    audiences: ["customer", "studio"], recipientResponsibilities: ["reviewer"],
    visibility: ["external", "internal", "recipient-private"], severity: "info", publicationStates: ["published"],
    safeExternalCopy: externalCopy("Review reminder", "A reviewer has been reminded to check the Stage.", "Review Stage"),
    deepLink: "project-stage", activityOnly: false, outcomes: audienceActionOutcomes,
    grouping: entityGrouping, quietHours: "respect", projectMute: "respect", retention: "project-history",
    privacy: "customer-safe-workflow", actorSuppression: "suppress-synchronous-success",
  }),
  "stage.review_updated": registerEvent({
    family: "stage", actor: "person-required", project: "required", stage: "event-stage", entityType: "stage",
    audiences: ["customer", "studio"], recipientResponsibilities: ["reviewer"],
    visibility: ["external", "internal", "recipient-private"], severity: "info", publicationStates: ["published"],
    safeExternalCopy: externalCopy("Updated Stage", "The Stage has changed since the review request was sent.", "Review Stage"),
    deepLink: "project-stage", activityOnly: false, outcomes: audienceActionOutcomes,
    grouping: entityGrouping, quietHours: "respect", projectMute: "respect", retention: "project-history",
    privacy: "customer-safe-workflow", actorSuppression: "suppress-synchronous-success",
  }),
...
export const notificationDeepLinkMap = {
  ...
  "project-overview": { pathTemplate: "/projects/{projectId}/stages/brief", fallbackTemplate: "/active-videos", routeStatus: "existing", roles: ["Studio Staff", "Studio Freelancer", "Customer"] },
  "project-stage": { pathTemplate: "/projects/{projectId}/{stagePath}", fallbackTemplate: "/projects/{projectId}/stages/brief", routeStatus: "existing", roles: ["Studio Staff", "Studio Freelancer", "Customer"] },
